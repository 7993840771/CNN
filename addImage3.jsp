		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="content">
					...
					<div class="post">
						<h2 class="title"><font color="#33CC33" face="Arial, Helvetica, sans-serif" size="+2">Image has been Uploaded Sucessfully. It Will </br>be Updated to your page soon.</font>
						</h2>
						
								<div class="entry">
					
<p></p>
<font color="#FF00FF" face="Times New Roman, Times, serif" size="+2">Upload Again...</font>

<p></p>
 <form name="s1" action="addvideo2.jsp" onClick="return validation()">
